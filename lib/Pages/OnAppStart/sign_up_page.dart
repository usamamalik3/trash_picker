...
import 'package:trash_picker/Pages/OnAppStart/sign_in_page.dart';
import 'package:trash_picker/Pages/OnAppStart/user_guide.dart';
import 'package:trash_picker/Pages/OnAppStart/welcome_guide_page.dart';
...
/*  SignUpPage({Key key, this.title}) : super(key: key);
  final String title;*/
  const SignUpPage({super.key,  this.app});
...
class _SignUpPageState extends State<SignUpPage> {
  ToastMessages _toastMessages =  ToastMessages();
