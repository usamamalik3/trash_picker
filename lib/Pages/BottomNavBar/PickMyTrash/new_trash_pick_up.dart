...
import 'package:trash_picker/Generators/uui_generator.dart';
...
import 'package:trash_picker/Widgets/toast_messages.dart';


class Newtrash_pickerUp extends StatefulWidget {
  final String accountType;

  Newtrash_pickerUp(this.accountType);

  @override
  _Newtrash_pickerUpState createState() => _Newtrash_pickerUpState();
}

class _Newtrash_pickerUpState extends State<Newtrash_pickerUp> {
  ...
  TextEditingController _trashLocationController =  TextEditingController();
  int charLength = 0;
  File? _image;
    ...
    firestoreInstance
        ...
        .set({
          ...
          'trashLocationLocation':
               ...
               GeoPoint(trashLocationLatitude!, trashLocationLongitude!),
          'startDate': startDate,
