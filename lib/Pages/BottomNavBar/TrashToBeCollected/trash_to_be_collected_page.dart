...
import 'package:trash_picker/Pages/BottomNavBar/TrashToBeCollected/trash_to_be_collected_list.dart';
          ...
          if (querySnapshot.docs.isNotEmpty) {
            querySnapshot.docs.forEach((result) {
              ...
              print(
                  ...
                  "latitude: ${trash_pickerUpsModel.trashLocationLocation!.latitude}\n"
                  "longitude: ${trash_pickerUpsModel.trashLocationLocation!.longitude}");
              setRecyclingCentersMarkers(
                trash_pickerUpsModel.trashID,
                trash_pickerUpsModel.trashName,
                trash_pickerUpsModel.trashLocationLocation!.latitude,
                trash_pickerUpsModel.trashLocationLocation!.longitude,
              );
            });
          }
        });
