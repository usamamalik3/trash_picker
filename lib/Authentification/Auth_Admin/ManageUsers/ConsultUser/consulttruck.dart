...
class Consulttruck extends StatefulWidget {
  const Consulttruck({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _ConsulttruckState();
  }
}

List<Object> _ListUser = [];

class _ConsulttruckState extends State<Consulttruck> {
  @override
